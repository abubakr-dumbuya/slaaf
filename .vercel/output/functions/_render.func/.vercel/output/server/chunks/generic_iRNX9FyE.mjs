...
import { d as addAttribute, g as unescapeHTML, l as renderTemplate, t as spreadAttributes, u as maybeRenderHead, v as createAstro } from "./server_Ggxk0Mtq.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_DnFoyrfg.mjs").catch((e) => {

...
var middlewareSecret = "1344b29b-88a7-4144-a14c-225ce4174612";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "1344b29b-88a7-4144-a14c-225ce4174612") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

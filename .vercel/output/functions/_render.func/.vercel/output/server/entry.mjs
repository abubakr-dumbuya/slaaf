...
var middlewareSecret = "bcd06340-b0d1-4dac-8400-c6dc7449d5d3";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "bcd06340-b0d1-4dac-8400-c6dc7449d5d3") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

...
var middlewareSecret = "3a781dd8-1262-415e-8589-5fcac30b3ad5";
//#endregion
...
var _page1 = () => import("./chunks/register_BKDiQQg9.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "3a781dd8-1262-415e-8589-5fcac30b3ad5") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

...
var middlewareSecret = "a2c33d72-865a-4dc0-befe-3abe6fefd067";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "a2c33d72-865a-4dc0-befe-3abe6fefd067") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

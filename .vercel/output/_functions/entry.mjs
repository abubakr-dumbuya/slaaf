...
var middlewareSecret = "79560a41-d23f-4e31-8846-d29129bcbe93";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "79560a41-d23f-4e31-8846-d29129bcbe93") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

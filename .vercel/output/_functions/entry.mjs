...
var middlewareSecret = "00c22180-04c4-4a9b-9f3c-0360ed7fbc53";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "00c22180-04c4-4a9b-9f3c-0360ed7fbc53") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

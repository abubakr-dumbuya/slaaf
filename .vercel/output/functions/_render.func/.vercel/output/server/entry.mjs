...
var middlewareSecret = "2169abd3-011f-4ecf-96d4-6771402541d2";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "2169abd3-011f-4ecf-96d4-6771402541d2") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

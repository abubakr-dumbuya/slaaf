...
var middlewareSecret = "69c5978d-f830-4d02-b876-9c3dfed47e57";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "69c5978d-f830-4d02-b876-9c3dfed47e57") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

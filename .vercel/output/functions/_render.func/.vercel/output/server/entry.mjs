...
var middlewareSecret = "74c085f8-012f-411a-97e7-96fe08aa97bf";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "74c085f8-012f-411a-97e7-96fe08aa97bf") realPath = url.searchParams.get(ASTRO_PATH_PARAM);

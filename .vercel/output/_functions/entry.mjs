...
var middlewareSecret = "55ab8576-573a-4ebd-8145-677839bf2969";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "55ab8576-573a-4ebd-8145-677839bf2969") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
